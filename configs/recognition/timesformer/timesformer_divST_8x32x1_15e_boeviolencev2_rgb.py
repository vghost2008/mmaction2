...
train_pipeline = [
    dict(type='UniformSampleFramesV2', clip_len=8, num_clips=1, test_mode=False,base_offset=0),
...
test_pipeline = [
    dict(type='UniformSampleFramesV2', clip_len=8, num_clips=1, test_mode=True,base_offset=0),
    dict(type='RawFrameDecode'),
...
work_dir = '/home/wj/ai/mldata/training_data/mmaction/work_dirs/timesformer_divST_8x32x1_15e_boeviolencev2/'
