...
ann_file_train = f'data/boeoffice/train_rawframes.txt'
ann_file_val = f'data/boeoffice/test_rawframes.txt'
ann_file_test = f'data/boeoffice/test_rawframes.txt'
img_norm_cfg = dict(
...
# runtime settings
work_dir = '/home/wj/ai/mldata/training_data/mmaction/work_dirs/tsm_k400_pretrained_r50_1x1x16_boeofficea/'
